...
// import 'package:geminai_realms/services/onboarding/onboarding_tooltips.dart';
...
//     final enabled =
//         ref.watch(onboardingTooltipsProvider.select((e) => e.enableTooltips));
//     final shown = ref.watch(onboardingTooltipsProvider
//         .select((e) => e.shownTooltips.contains(type)));
//     WidgetsBinding.instance.addPostFrameCallback((_) {
//       if (!shown && enabled) {
//         ref
//             .read(onboardingTooltipsProvider)
//             .tooltipControllers[type]
//             ?.showTooltip();
//       } else {
//         if (ref
//                 .read(onboardingTooltipsProvider)
...
//       content: Text(
//         message,
//         style: AppFonts.onboardingTooltip(size)
//             .copyWith(color: AppColors.onboardingTooltipForeground),
//       ),
//       arrowTipDistance: 30,
